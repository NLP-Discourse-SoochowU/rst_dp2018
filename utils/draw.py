...
def draw_all_parsed():
    ...
    for draw_file in strtrees_dict.keys():
        ...
        draw_one_tree(strtree, draw_file, user_choice)


def draw_one_tree(strtree, draw_file, user_choice):
    cf = CanvasFrame()
    ...
    if not LOAD_TEST:
        ...
        edu_path = RST_DT_TEST_PATH + "/" + draw_file.split("/")[2].split(".")[0] + ".out.edus"
